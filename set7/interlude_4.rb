# interlude_4.rb — "pressure drop"  (set7: trimmed to ~86s)
# 200 BPM | Bb | escalating drums — sparse kick to full blast beat over noise wall
# kit: bd_klub / sn_dolf
#
# run_file "/Users/logan/Projects/chiptune/set7/interlude_4.rb"
...
in_thread do
  sample noise_loop, amp: 0.60, attack: 1.0, sustain: 84.0, release: 1.0
  sample dark_noise, amp: 0.65, attack: 0.5, sustain: 84.0, release: 0.5
end
...
in_thread do
  with_fx :bitcrusher, bits: 3, sample_rate: 0.07 do
    with_fx :distortion, distort: 0.99 do
      use_synth :chipbass
      play :bb0, sustain: 84.0, release: 4.0, amp: 3.0, cutoff: 50
      play :f1,  sustain: 84.0, release: 4.0, amp: 1.5, cutoff: 44
    end
  end
  sleep 288
end
