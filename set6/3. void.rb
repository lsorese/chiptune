# void.rb — set6: +20% length via SONG_END 8→10 (verse I reprise as natural coda)
...
# sec 3 — breakdown:    whole-note bass, beat 1 kick, snare on 3, crash
# (extra 2 sections wrap back to sec 0 — stripped verse I reprise before silence)
#
# run_file "/Users/logan/Projects/chiptune/set6/3. void.rb"
...
# ── Texture — glitch_perc4 chorus accent + ambi_sauna breakdown ───────────────
...
live_loop :texture, sync: :conductor do
  ...
  when 2
    8.times do
      sample GPERC_V, amp: 0.4, rate: rrand(0.85, 1.15)
      sleep 4
    end
  when 3
    sample ASAUNA_V, amp: 0.3, attack: 3.0, release: 5.0
    sleep 32
  else
    sleep 32
  end
