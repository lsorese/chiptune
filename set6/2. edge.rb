# edge.rb — set6: +20% length — t=8,9 forced to sec 1 (stripped breakdown coda after final blast)
...
# (t=8,9 play sec 1 — a quiet crash-and-bass outro after the blast peak)
#
# run_file "/Users/logan/Projects/chiptune/set6/2. edge.rb"
