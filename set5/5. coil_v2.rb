# coil_v2.rb — original + glitch_perc1 chorus accent + ambi_soft_buzz breakdown
#
# run_file "/Users/logan/Projects/chiptune/set5/4. coil_v2.rb"
...
# ── Texture — glitch_perc1 chorus accent + ambi_soft_buzz breakdown ───────────
live_loop :texture, sync: :conductor do
  ...
  when 2
    sample BUZZ, amp: 0.25, attack: 3.0, release: 5.0
    sleep 32
  else
    sleep 32
  end
