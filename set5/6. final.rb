...
# sec 2 — heavy chorus:  gallop bass, double kick, 16th hats, stabs (arp rests)
# sec 3 — outro:         whole-note bass, beat 1 kick only, crash, arp with long echo
#
# run_file "/Users/logan/Projects/chiptune/set5/6. final.rb"
...
# sec 0: 2 chords × 8 notes × sleep 2 = 32 beats ✓  (Am + F only, half-notes)
# sec 1,3: 4 chords × 8 notes × sleep 1 = 32 beats ✓
ARP_UP = [
...
# ── Chip bass ─────────────────────────────────────────────────────────────────
# sec 0,3: whole notes (2×4×sleep4 = 32) ✓
...
# ── Kick ──────────────────────────────────────────────────────────────────────
# sec 0,3: beat 1 only (8×sleep4 = 32) ✓
...
# ── Texture — glitch_perc1 chorus accent + ambi_choir outro ───────────────────
