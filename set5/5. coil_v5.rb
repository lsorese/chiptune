# coil_v5.rb — v2 + noise drone layered into breakdown + escalating glitch at the end
#
# run_file "/Users/logan/Projects/chiptune/set5/4. coil_v5.rb"
...
# ── Texture ───────────────────────────────────────────────────────────────────
# chorus:    glitch_perc1 every 4 beats (from v2)
# breakdown: buzz + noise drone + loud chaotic glitch hits every half-beat
# verse 1:   sparse glitch (t=6)
# verse 2:   escalating glitch_perc1 + glitch_robot2 (t=7, final pass)
live_loop :texture, sync: :conductor do
  ...
  when 3
    if t == 7
      # first half: sparse glitch starts creeping in
      16.times do
        sample GLITCH, amp: 0.45 if one_in(4)
        sleep 1
      end
      # second half: denser, random glitch perc added, pitch wobble
      16.times do
      ...
      # t=6, first verse reprise: just a little glitch, nothing dramatic
      32.times do
