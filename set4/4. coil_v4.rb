# coil_v4.rb — original + dark pink noise hat layer + ambi_haunted_hum breakdown
#
# run_file "/Users/logan/Projects/chiptune/set4/4. coil_v4.rb"

use_bpm 160

SONG_END = 8

NOISE = "/Users/logan/Projects/chiptune/samples/noise loops/rand-stream-dark-pink.wav"
HAUNT = "/Users/logan/Projects/chiptune/samples/ambient/ambi_haunted_hum.flac"
...
# ── Texture — dark pink noise hat layer (all sections) + ambi_haunted_hum breakdown
# noise bursts ride quietly on top of hat_snap, more audible in the sparse breakdown
live_loop :texture, sync: :conductor do
  ...
  when 0, 3
    64.times do |i|
      sample NOISE, amp: 0.18, finish: 0.04, attack: 0, release: 0.04 if i.odd?
      sleep 0.5
    end
  when 1
    128.times do |i|
      sample NOISE, amp: 0.15, finish: 0.03, attack: 0, release: 0.03
      sleep 0.25
    end
  when 2
    sample HAUNT, amp: 0.35, attack: 2.0, release: 6.0
    sleep 32
  end
end
