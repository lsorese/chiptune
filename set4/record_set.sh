#!/usr/bin/env bash
# record_set.sh — records the full set as one continuous WAV
#
# Requires: Sonic Pi 4 running
# Usage: bash record_set.sh

set -e

SP4="/Users/logan/Projects/chiptune/set4/sp4"
SCRIPT_DIR="/Users/logan/Projects/chiptune/set4"
OUT="$SCRIPT_DIR/wavs/set4_full.wav"

mkdir -p "$SCRIPT_DIR/wavs"

# gap between tracks (seconds) — lets release tails fade before next track starts
GAP=3

# durations in seconds (track play time, not including the gap)
declare -a TRACKS=(
  "0. intro.rb:40"
  "1. fault.rb:102"
  "2. edge.rb:120"
