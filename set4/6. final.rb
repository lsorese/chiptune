...
#
# run_file "/Users/logan/Projects/chiptune/set4/6. final.rb"
...
# 8 notes × sleep 1 × 4 chords × 1 pass = 32 beats ✓
ARP_UP = [
...
live_loop :arp, sync: :conductor do
  ...
  sec = (t / 2) % 4
  if sec != 2
    echo_decay = sec == 3 ? 4.0 : 2.0
    reverb_mix = sec == 3 ? 0.35 : 0.12
    with_fx :bitcrusher, bits: 8, sample_rate: 0.5 do
      with_fx :echo, phase: 0.5, decay: echo_decay, mix: 0.25 do
